                ...
                <div className="grid grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <details className="group/details">
                      <summary className="cursor-pointer p-3 rounded-lg hover:bg-gray-100 transition-colors flex items-start gap-3">
                        <span className="text-xl mt-0.5">🔇</span>
                        <div>
                      ...
                      <div className="ml-9 mt-2 space-y-2 text-sm">
                        <Link href="/hearing-health/hearing-loss/signs-of-hearing-loss" className="block text-gray-600 hover:text-blue-600 py-1">Signs of Hearing Loss</Link>
                        <Link href="/hearing-health/hearing-loss/causes-of-hearing-loss" className="block text-gray-600 hover:text-blue-600 py-1">Causes of Hearing Loss</Link>
                        <Link href="/hearing-health/hearing-loss/types-of-hearing-loss" className="block text-gray-600 hover:text-blue-600 py-1">Types of Hearing Loss</Link>
                        <Link href="/hearing-health/hearing-loss/hearing-loss-in-adults" className="block text-gray-600 hover:text-blue-600 py-1">Hearing loss in adults</Link>
                        <Link href="/hearing-health/hearing-loss/hearing-loss-in-child" className="block text-gray-600 hover:text-blue-600 py-1">Hearing loss in Child</Link>
                      </div>
                    </details>
                    <details className="group/details">
                      <summary className="cursor-pointer p-3 rounded-lg hover:bg-gray-100 transition-colors flex items-start gap-3">
                      ...
                      <div className="ml-9 mt-2 space-y-2 text-sm">
                        <Link href="/hearing-health/tinnitus/symptoms-causes" className="block text-gray-600 hover:text-blue-600 py-1">Symptoms & Causes</Link>
                        <Link href="/hearing-health/tinnitus/tinnitus-therapy" className="block text-gray-600 hover:text-blue-600 py-1">Tinnitus Therapy</Link>
                      </div>
                    </details>
                  </div>
                </div>
