...
export default function ChargingSolutionsPage() {
  ...
  const batteries = [
    ...
    {
      name: "Rexton Hearing Aid Batteries",
      description: "Reliable zinc-air batteries for Rexton non-rechargeable hearing aids.",
      sizes: "Size 10, 312, 13, 675",
      image: "/images/Targa_P_5A_no_shadow_beige_tif_940039474013207443_940039474013207443.png",
      brand: "Rexton"
    },
  ]
  ...
  const accessories = [
    ...
    {
      name: "Signia Cleaning Kit",
      description: "Professional hearing aid cleaning kit with brushes, wax guards, and protective case.",
      image: "/images/Dry-Clean-Charger-Pure_closed_LED_1920x1080.webp",
      brand: "Signia"
    },
    {
