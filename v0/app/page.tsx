...
export default function HomePage() {
  ...
  const featuredSigniaIds = ["pure-ric-1", "styletto-ix-1", "motion-1", "insio-1", "silk-1", "intuis-1"]
        ...
        Careers
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              {/* WhatsApp */}
              <a href="https://api.whatsapp.com/send/?phone=9668001248882" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-[#00838f] transition-colors hover:scale-110" aria-label="WhatsApp">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/albarakat-hearing-care/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-[#00838f] transition-colors hover:scale-110" aria-label="LinkedIn">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* X (Twitter) */}
              <a href="https://x.com/BarakatHearing" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-[#00838f] transition-colors hover:scale-110" aria-label="X (Twitter)">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/albarakathearing" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-[#00838f] transition-colors hover:scale-110" aria-label="Instagram">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/BarakatHearingCareCenters" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-[#00838f] transition-colors hover:scale-110" aria-label="Facebook">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/@albarakathearingcare" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-[#00838f] transition-colors hover:scale-110" aria-label="YouTube">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>

            </div> {/* Closes the new social media flex row */}
          </div> {/* Closes the Contact column */}
        </div> {/* Closes the footer grid layout */}
      </div> {/* Closes the main footer container */}
    </footer>
