...
export const productsMenuStructure = {
  categories: [
      ...
      submenu: [
        {
          ...
          items: [
            { 
              id: "pure", 
              label: "Pure", 
              // التعديل هنا: المسار الصحيح للسماعة
            ...
            { 
              ...
              // المسار الجديد اللي عملناه للسماعة دي
    ...
    {
      id: "accessories-batteries", // تأكد من مطابقة الـ ID للـ Map في المنيو
      label: "Accessories and Batteries",
      icon: "Battery",
      href: "/products/accessories-batteries",
    },
    {
      id: "connectivity", // تأكد من مطابقة الـ ID للـ Map في المنيو
      label: "Connectivity",
      icon: "Wifi",
